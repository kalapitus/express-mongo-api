...
# backend-api
Back-end RESTful API built using Node.js, Express and MongoDB
...
1. `cd` into your local server folder
2. Clone the repository:
    - git clone link
3. Open terminal and install dependencies. List of names of the dependencies can be found in the package.json file under section dependencies.
    - npm install {dependency_name}

4. Create .env file and write down:
    -
